        ...
        <div className="orchid-detail-grid">
          <div className="orchid-detail-image">
            ...
            <div className="orchid-detail-badges">
              {orchid.isSpecial && <span className="detail-badge special">☀️ Đặc biệt</span>}
              {orchid.isNatural && <span className="detail-badge natural">🌱 Tự nhiên</span>}
            </div>
          </div>
          ...
          <div className="orchid-detail-info">
            ...
            <div className="info-section">
              ...
              <div className="detail-item rating-item">
                ...
                <span className="detail-value rating-stars">
                  {Array(orchid.rating).fill().map((_, i) => (
              ...
              <div className="detail-item">
                ...
                <span className="detail-value likes-count">{orchid.numberOfLike} ❤️</span>
              </div>
            </div>
            ...
            <div className="info-section description-section">
              ...
              <p className="detail-description">
                Đây là loài hoa lan {orchid.name} có màu {orchid.color}, xuất xứ từ {orchid.origin}, thuộc loại {orchid.category}. 
                {orchid.isSpecial ? ' Đây là một loài hoa lan đặc biệt với đặc tính quý hiếm. ' : ' '}
                {orchid.isNatural ? 'Loài lan này được trồng hoàn toàn tự nhiên, không sử dụng phân bón hóa học.' : 'Loài lan này được trồng bằng phương pháp canh tác hiện đại.'}
              </p>
            </div>
          </div>
        </div>
